...
public class GoPluginImplTest {
    ...
    public void shouldGetCorrectDockerCmd() {
        ...
        assertThat(plugin.getDockerCmd("/work", "maven3", "mvn clean install -s settings.xml"),
        ...
        assertThat(plugin.getDockerCmd("/work", "node6", "npm install --registry https://registry.npm.taobao.org"),
